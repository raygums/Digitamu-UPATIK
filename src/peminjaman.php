...
$fasilitas = fetchAll(query("SELECT id, nama_fasilitas, jenis FROM ref_fasilitas WHERE deleted_at IS NULL AND is_available = TRUE ORDER BY jenis, nama_fasilitas"));
