<?php
/**
 * Landing Page - DigiTamu TIK (Remote Access)
 * Untuk tamu yang mengakses dari jarak jauh
 */
$base_url = '';
?>
<!DOCTYPE html>
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    ...
                    <div class="service-card bg-white rounded-2xl p-8 text-center">
                        ...
                        <a href="src/janji-temu.php" class="block w-full bg-[#38bdf8] hover:bg-[#0ea5e9] text-white font-semibold py-3 px-6 rounded-lg transition-colors text-sm">
                            Buat Jadwal
                        </a>
                    </div>
                    ...
                    <div class="service-card bg-white rounded-2xl p-8 text-center">
                        ...
                        <a href="src/peminjaman.php" class="block w-full bg-[#38bdf8] hover:bg-[#0ea5e9] text-white font-semibold py-3 px-6 rounded-lg transition-colors text-sm">
                            Ajukan Pinjaman
                        </a>
                    </div>
